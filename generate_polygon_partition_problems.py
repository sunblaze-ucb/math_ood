...
def main():
    ...
    generate_dataset(num_images=args.train_samples, min_diagonals=1, max_diagonals=3, seed=args.seed, output_path=os.path.join(args.output_dir, "geometry_polygon_rotation_7B_train.jsonl"))
    generate_dataset(num_images=args.test_in_samples, min_diagonals=1, max_diagonals=3, seed=args.seed, output_path=os.path.join(args.output_dir, "geometry_polygon_rotation_7B_test_in.jsonl"))
    generate_dataset(num_images=args.test_out_samples, min_diagonals=4, max_diagonals=4, seed=args.seed, output_path=os.path.join(args.output_dir, "geometry_polygon_rotation_7B_test_out.jsonl"))
