...
def generate_dataset(num_images=100, min_diagonals=5, max_diagonals=13, line_width=3, seed=0, output_path=None):
    np.random.seed(seed)
    lines = []
    for i in range(num_images):
        ...
        lines.append(json.dumps(newjson))
...
def main():
    ...
    generate_dataset(num_images=args.train_samples, min_diagonals=7, max_diagonals=13, line_width=3, seed=args.seed, output_path=os.path.join(args.output_dir, "geometry_perpendicular_intersection_7B_train.jsonl"))
    generate_dataset(num_images=args.test_in_samples, min_diagonals=7, max_diagonals=13, line_width=3, seed=args.seed, output_path=os.path.join(args.output_dir, "geometry_perpendicular_intersection_7B_test_in.jsonl"))
    generate_dataset(num_images=args.test_out_samples, min_diagonals=14, max_diagonals=20, line_width=3, seed=args.seed, output_path=os.path.join(args.output_dir, "geometry_perpendicular_intersection_7B_test_out.jsonl"))
